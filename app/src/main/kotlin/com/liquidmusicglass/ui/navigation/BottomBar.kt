...
import com.liquidmusicglass.ui.liquid.DampedDragAnimation
import com.liquidmusicglass.ui.liquid.InteractiveHighlight
...
// ─────────────────────────────────────────────────────────────────
//  LocalLiquidBottomTabScale — масштаб иконок в accent-слое
// ─────────────────────────────────────────────────────────────────

private val LocalLiquidBottomTabScale = compositionLocalOf { { 1f } }
...
// ═════════════════════════════════════════════════════════════════
//  NavigationCapsule — точная архитектура Kyant0 LiquidBottomTabs
// ═════════════════════════════════════════════════════════════════
...
private fun NavigationCapsule(
    ...
    val isLightTheme = !LiquidTheme.colors.isDark
    val accentColor =
        if (isLightTheme) Color(0xFFFC3C44)
        else Color(0xFFFC3C44)
    val containerColor = LiquidTheme.colors.bottomBarTint
    ...
    BoxWithConstraints(
            ...
            Modifier
                ...
                .drawBackdrop(
                    ...
                    effects = {
                        vibrancy()
                        blur(4f.dp.toPx())
                        lens(24f.dp.toPx(), 40f.dp.toPx(), chromaticAberration = true)
                    },
                    highlight = {
                        Highlight.Ambient
                    },
        ...
        // ── СЛОЙ 2: Скрытый accent-слой (alpha=0, 56dp) ──
...
private fun NavItemContent(
    ...
    val contentColor by animateColorAsState(
        targetValue = if (isSelected) appleRed else defaultColor,
